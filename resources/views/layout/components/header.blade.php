        ...
        <ul class="navbar-nav navbar-right">
            <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right" style="height: 40vh;">
                    ...
                    <div class="dropdown-list-content dropdown-list-icons">
                        <a href="{{ route('pengurus/verifikasi') }}" class="dropdown-item dropdown-item-unread"
                            id="notif_bar">
                            <div class="dropdown-item-icon bg-primary text-white" id="notif_pengurus">
                            </div>
                            <div class="dropdown-item-desc">
                                <div class="time">Terdapat Pendaftaran yang harus di verifikasi</div>
                            </div>
                        </a>
                        <a href="{{ route('pengurus/pembayaran') }}" class="dropdown-item dropdown-item-unread"
                            id="payment_bar">
                            <div class="dropdown-item-icon bg-primary text-white" id="payment_pengurus">
                            </div>
                            <div class="dropdown-item-desc">
                                <div class="time">Terdapat Pembayaran yang harus di verifikasi</div>
                            </div>
