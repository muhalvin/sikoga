                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="invoice-title">
                                <h4 class="float-end font-size-15">Invoice #PMBREG00{{ $item->id }}
                                    @if ($item->status == 2)
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="text-muted">
                                        ...
                                        <h5 class="font-size-15 mb-2">{{ Auth::user()->nama }}</h5>
                                ...
                                <div class="col-sm-6">
                                    <div class="text-muted text-sm-end">
                                        <div>
                                            ...
                                            <p>#PMBREG00{{ $item->id }}</p>
                                        </div>
                                        <div class="mt-4">
                                            <h5 class="font-size-15 mb-1">Invoice Date:</h5>
                                            <p>{{ date('d M Y', strtotime($item->tanggal_bayar)) }}</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
                            ...
                            <div class="py-2">
                                ...
                                <div class="d-print-none mt-4">
                                    <div class="float-end">
                                        <a href="{{ route('pembayaran') }}" class="btn btn-primary me-1">
                                            Kembali
                                        </a>
