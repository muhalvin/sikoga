                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ url('storage/KOS/Foto') }}/{{ $item->f_samping }}" alt=""
                                        onerror="this.onerror=null; this.src='{{ url('assets/img/default/default.jpg') }}'"
                                        style="width: 100%; height:100%; max-height: 40vh;">
                                </div>
                                <div class="form-group">
                                    <label>Foto Lainnya</label>
                                    <img src="{{ url('storage/KOS/Foto') }}/{{ $item->f_kamar_1 }}" alt=""
                                        onerror="this.onerror=null; this.src='{{ url('assets/img/default/default.jpg') }}'"
                                        style="width: 100%; height:100%; max-height: 40vh;">
                                </div>
                                <div class="form-group">
                                    <label>Foto Lainnya</label>
                                    <img src="{{ url('storage/KOS/Foto') }}/{{ $item->f_kamar_2 }}" alt=""
                                        onerror="this.onerror=null; this.src='{{ url('assets/img/default/default.jpg') }}'"
                                        style="width: 100%; height:100%; max-height: 40vh;">
                                </div>
                                <div class="form-group">
                                    <label>Foto Lainnya</label>
                                    <img src="{{ url('storage/KOS/Foto') }}/{{ $item->f_kamar_3 }}" alt=""
                                        onerror="this.onerror=null; this.src='{{ url('assets/img/default/default.jpg') }}'"
                                        style="width: 100%; height:100%; max-height: 40vh;">
                                </div>
                            </div>
